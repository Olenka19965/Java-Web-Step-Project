...
import com.tinder.dao.user.SqlUserProfileDao;
...
public class WebServer {
    public static void main(String[] args) throws Exception {
        try (Connection conn = DbUtil.getConnection()) {
            ...
            UserProfileDao userDao = new SqlUserProfileDao();
//            UserProfileService usersService = new UserProfileService(userDao);
...
//            handler.addServlet(new ServletHolder(new UserListServlet(te,usersService)), "/userlist");
